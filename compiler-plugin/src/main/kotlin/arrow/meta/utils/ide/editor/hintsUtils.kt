...
/**
 * Use [LanguageExpressionTypes.INSTANCE]
 * Can easily generalized to PsiElements
 */
fun addExpressionTypeProvider(
  informationHint: (element: KtExpression) -> String,
  expressionAt: (elementAt: PsiElement) -> MutableList<KtExpression>,
  errorHint: String
): ExpressionTypeProvider<KtExpression> =
...
/**
 * Use [LanguageParameterInfo.INSTANCE]
 * @param findElementForUpdatingParameterInfo returning null removes hint
 */
fun <Owner : PsiElement, Type> addParameterInfoHandler(
...
/**
 * Type being an Descriptor check Subtypes of [org.jetbrains.kotlin.idea.parameterInfo.KotlinTypeArgumentInfoHandlerBase] or [org.jetbrains.kotlin.idea.parameterInfo.KotlinParameterInfoWithCallHandlerBase]
 */
fun <Owner : PsiElement, Type, ActualType : PsiElement> addParameterInfoHandlerForKotlin(
  ...
  findElementForUpdatingParameterInfo: (context: UpdateParameterInfoContext) -> Owner?,
  findElementForParameterInfo: (context: CreateParameterInfoContext) -> Owner?
): ParameterInfoHandlerWithTabActionSupport<Owner, Type, ActualType> =
 ...
 */
fun <Type : DeclarationDescriptor> addParameterInfoHandlerForKotlin(
  ...
  argumentListAllowedParentClasses: MutableSet<Class<Any>>
): KotlinTypeArgumentInfoHandlerBase<Type> =
 ...
 */
inline fun <reified ArgumentList : KtElement, reified Argument : KtElement> addParameterInfoHandlerForKotlin(
  noinline actualParameters: (o: ArgumentList) -> Array<Argument>,
  actualParametersRBraceType: IElementType,
  argumentListAllowedParentClasses: MutableSet<Class<Any>>
): KotlinParameterInfoWithCallHandlerBase<ArgumentList, Argument> =
  object : KotlinParameterInfoWithCallHandlerBase<ArgumentList, Argument>(ArgumentList::class, Argument::class) {
